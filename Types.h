...
typedef void(*pfHash) (const void * blob, const int len, void* seed, void * out);
...
public:
    ...
    inline void operator () (const void * key, const int len, void* seed, uint32_t * out)
    {
    ...
    inline T operator () (const void * key, const int len, void* seed)
    {
        T result;
